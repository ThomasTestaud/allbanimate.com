      ...
      <div class="tool-section">
        ...
        <div class="edit-section">
          <div>
            ...
            <div>
              <BtnHoverTag @click="createNewLayer" :name="'plus'" :tag="'Create new layer'"/>
              <BtnHoverTag v-if="renamingLayer" @click="renameLayerFalse" :name="'edit'" :tag="'Rename layers'" class="selected"/>
              <BtnHoverTag v-else @click="renameLayerTrue" :name="'edit'" :tag="'Rename layers'"/>
              <BtnHoverTag @click="deleteSelectedLayer" :name="'delete'" :tag="'Delete layer'"/>
            </div>
          </div>
          <div>
            <div class="sub-text">Frame:</div> 
            <div>
              <BtnHoverTag @click="createNewFrame" :name="'plus'" :tag="'Create new frame'"/>
              <BtnHoverTag @click="copyFrame" :name="'copy'" :tag="'Copy frame'"/>
              <BtnHoverTag @click="pasteFrame" :name="'paste'" :tag="'Paste frame'"/>
              <BtnHoverTag @click="deleteSelectedFrame" :name="'delete'" :tag="'Delete selected frame'"/>
            </div>
          </div>
          <div>
            <div class="sub-text">Image:</div>
            <div>
              <BtnHoverTag @click="blackCanvas" :name="'plus'" :tag="'Create empty image'"/>
              <BtnHoverTag @click="copyImage" :name="'copy'" :tag="'Copy image'"/>
              <BtnHoverTag @click="pasteImage" :name="'paste'" :tag="'Paste image'"/>
              <BtnHoverTag @click="emptyCanvas" :name="'delete'" :tag="'Delete image'"/>
            </div>
          </div>
        </div>
        ...
        <div v-for="(calk, calkIndex) in calkLayers" :key="calk" class="layer" @click="selectedCalk = calkIndex">
          <span v-if="calkIndex == selectedCalk" class="layer-head layer-head-selected">
            ...
            <div class="layer-arrows">
              <button class="btn-svg-2" @click="moveLayerTowardTop(calkIndex)">
              ...
              <button class="btn-svg-2" @click="moveLayerTowardBottom(calkIndex)">
...
import BtnHoverTag from '../components/BtnHoverTag.vue';
